...
public class Mainzinha {
    ...
    public Mainzinha(int quantum, int trocaDeContexto, List<Processo> lista){
        QUANTUM = quantum;
        TC = trocaDeContexto;
    ...
    public void executar(){
        ...
        int tempo = 0, contadorQuantum = QUANTUM, i = 0, trocaDeContexto = TC;
        
        while(listaDeProcessos.size() > terminados.size()){
            System.out.println("Tamanho de terminados: "+terminados.size());
            ...
            if(isSwappingContext()){
                ...
                System.out.println(RED_BOLD_BRIGHT+"EXECUTANDO..."+RESET);
                //input.nextLine();
                    ...
                    if(processo.isOn()){
                        ...
                        try{
                            ...
                            if(--contadorQuantum==0){
                                ...
                                fila.add(fila.poll());
                                execOff();
                                System.out.println(GREEN_BOLD_BRIGHT+"O tempo de execucao restante do processo é "+(processo.getDuracao()-processo.getExecucao())+RESET);
                                swappOn();
                                trocaDeContexto = TC;
                            }
                        }
